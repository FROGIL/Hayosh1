var discordInvite = discordInvite || function() {
    ...
    return {
        init: function(e) {
            e.inviteCode = void 0 !== e.inviteCode && e.inviteCode, e.title = void 0 !== e.title ? e.title : "", e.introText = void 0 !== e.introText ? e.introText : "Вы были приглашены на сервер", e.joinText = void 0 !== e.joinText ? e.joinText : "Войти", e.joinedText = void 0 !== e.joinedText ? e.joinedText : "Выполнено", e.width = void 0 !== e.width ? e.width : 400, e.miniMode = void 0 !== e.miniMode && e.miniMode, e.hideIntro = void 0 !== e.hideIntro && e.hideIntro, e.targetElement = void 0 !== e.targetElement ? e.targetElement : "#discordInviteBox", i.inviteCode = e.inviteCode, i.title = e.title, i.introText = e.introText, i.joinText = e.joinText, i.joinedText = e.joinedText, i.miniMode = e.miniMode, i.hideIntro = e.hideIntro, i.width = e.width, i.targetElement = e.targetElement
        },
        render: function() {
            if (window.jQuery) d();
            else {
            ...
            function d() {
                if (discordCode = i.inviteCode, discordCode && "" != discordCode) {
                    ...
                    $(i.targetElement).append(t).attr("version", e), $.ajax({
                        ...
                        success: function(e) {
                            e.code;
                            var t = e.approximate_member_count.toLocaleString("ru") + " всего",
                                o = e.approximate_presence_count.toLocaleString("ru") + " в сети",
                                n = e.guild.name,
